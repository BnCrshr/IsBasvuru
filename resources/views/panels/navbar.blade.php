  ...
  <ul class="nav navbar-nav align-items-center ms-auto">
    <li class="nav-item dropdown dropdown-language">
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
        <a class="dropdown-item" href="{{ url('lang/de') }}"  data-language="en">
            <i class="flag-icon flag-icon-tr"></i> Türkçe
        </a>
        <a class="dropdown-item" href="{{ url('lang/en') }}"data-language="de">
    ...
    <li class="nav-item dropdown dropdown-user">
      <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
        ...
        <span class="avatar">
            <img class="round"
                 src="https://media.licdn.com/dms/image/C4D0BAQGewvzxcLnxgQ/company-logo_200_200/0/1605526309164?e=2147483647&v=beta&t=fjmZJdbwEZQOR3LPxAgrYk88YouKkwc4GQnJCAfQ4OA"
      ...
      <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
        ...
        <a class="dropdown-item"
          ...
          <i class="me-50" data-feather="user"></i> Yönetici Modülü
        </a>
