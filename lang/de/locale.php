...
return [
    "Apps & Pages" => "Job Application Module",
    "User Interface" => "Personnel Transactions",
    "Dashboards" => "Dashboards",
    "eCommerce" => "General İnformation",
    "Apps" => "Apps",
    "Forms & Tables" => "Teams And Porjects",
    "Pages" => "Pages",
    "Charts & Maps" => "Management ",
    "Others" => "Others",
